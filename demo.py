...
# export PYTHONPATH=$PYTHONPATH:/data2/local_userdata/gaobowen/streaming_reconstruction/cut3r/src
# python demo.py --model_path /data2/local_userdata/gaobowen/streaming_reconstruction/cut3r/src/checkpoint/cut3r_512_dpt_4_64.pth --seq_path /data2/local_userdata/gaobowen/streaming_reconstruction/cut3r/dataset/test --size 512 --vis_threshold 1.5 --output_dir /data2/local_userdata/gaobowen/streaming_reconstruction/cut3r/output
# python demo_ga.py --model_path /data2/local_userdata/gaobowen/streaming_reconstruction/cut3r/src/checkpoint/cut3r_512_dpt_4_64.pth --seq_path /data2/local_userdata/gaobowen/streaming_reconstruction/cut3r/dataset/new2.mp4 --size 512 --vis_threshold 1.5 --output_dir /data2/local_userdata/gaobowen/streaming_reconstruction/cut3r/output/demo_ga
# CUDA_VISIBLE_DEVICES=1 PYTHONPATH=./src python demo.py --model_path /data2/local_userdata/gaobowen/streaming_reconstruction/cut3r/src/checkpoint/cut3r_512_dpt_4_64.pth --seq_path /data2/local_userdata/gaobowen/streaming_reconstruction/cut3r/dataset/new2.mp4 --size 512 --vis_threshold 1.5 --output_dir /data2/local_userdata/gaobowen/streaming_reconstruction/cut3r/output/demo